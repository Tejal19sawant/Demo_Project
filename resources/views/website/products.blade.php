                        ...
                        <div class="filter-sidebar-left">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                ...
                                <div class="list-group-collapse sub-men">
                                    <a class="list-group-item list-group-item-action" href="#{{$cat->id}}" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">{{$cat->category_name}}  <small class="text-muted">(100)</small>
                                </a>
                                   
                                    <div class="collapse show" id="{{$cat->category_id}}" data-parent="#list-group-men">
                                        @foreach($product_detls as $prod)
                                        <div class="list-group">
                                            <a href="#" class="list-group-item list-group-item-action active">{{$prod->name}} <small class="text-muted">(50)</small></a>
                                        </div>
                                        @endforeach
                                    </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="{{asset('images/website_images/img-pro-01.jpg')}}" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
