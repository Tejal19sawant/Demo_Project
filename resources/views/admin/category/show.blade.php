                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Category Name </th><td> {{ $category->category_name }} </td></tr><tr><th> Category Description </th><td> {{ $category->category_description }} </td></tr><tr><th> Status </th><td> {{ $category->status }} </td></tr>
                                </tbody>
                            </table>
                        </div>
